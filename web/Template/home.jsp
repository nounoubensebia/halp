      ...
      <section class="dark-grey-text text-center">
        ...
        <!-- Heading -->
          <div class="card mb-4 wow fadeIn">
            ...
            <!--Card content-->
            <div class="card-body d-sm-flex justify-content-around">


              <form class="d-flex flex-fill">
                <!-- Default input -->
                <input type="search" placeholder="Que recherchez-vous? Nom du service, utilisateur, ville, description" aria-label="Search" class="form-control col-6 mr-2">
                <select class="browser-default custom-select mr-2">
                ...
                <select class="browser-default custom-select mr-2">
                  <option selected disabled>Nature de service</option>
                  <option value="1">One</option>
                  <option value="2">Two</option>
                  <option value="3">Three</option>
                </select>
                <select class="browser-default custom-select mr-2">
                  <option selected disabled>Début</option>
                  <option value="1">Mars 2020</option>
                  <option value="2">Avril 2020</option>
                  <option value="3">Mai 2020</option>
                </select>
